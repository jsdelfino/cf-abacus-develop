...
// Down sample the time component of a unique time-based id
const downsample = (id, div) => {
  const t = parseInt(id);
  const ft = Math.floor(t / div) * div;
  return pad16(ft) + id.substr(id.indexOf('-'));
};

// Export our public functions
module.exports = seqid;
module.exports.pad16 = pad16;
module.exports.downsample = downsample;
